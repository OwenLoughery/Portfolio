...
class TestList(unittest.TestCase):
    ...
    def test_01(self):
        ...
        conc.load_concordance("file1.txt")
    ...
    def test_02(self):
        conc = Concordance()
        conc.load_stop_table("stop_words.txt")
        conc.load_concordance("file2.txt")
    ...
    def test_03(self):
        conc = Concordance()
        conc.load_stop_table("stop_words.txt")
        conc.load_concordance("declaration.txt")
    ...
    def test_07(self):
        ...
        with self.assertRaises(FileNotFoundError) as context:
            conc.load_stop_table("nonexistent_file.txt")
        with self.assertRaises(FileNotFoundError) as context:
            conc.load_concordance("nonexistent_file.txt")
